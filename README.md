...
├── GB_model.py # Transformer model definition<br>
├── GB_FW_Train.py # Standard training (BT only)<br>
├── GB_J_Train.py # Jacobian‑constrained fine‑tuning<br>
├── Generate_FW_Dataset.py # Build HDF5 dataset (inputs + BT)<br>
├── Generate_J_Dataset.py # Build HDF5 dataset (inputs + BT + Jacobians)<br>
└── scalers/ # Saved MinMaxScalers and Jacobian stats<br>
